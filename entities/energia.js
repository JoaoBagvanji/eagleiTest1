...
var energiaSchema=new mongoose.Schema({
	// regiao:String,
	// jobcard_cod:String,
	// regiao_ref:String,
	// departamento:String,
...
energiaSchema.statics.gravar_energia=function(armaz, callback){
	this.create(armaz, callback)
}

module.exports=mongoose.model("Energia", energiaSchema, "Energia");